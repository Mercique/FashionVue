<template>
  <footer class="footer">
    <div class="footer__up center">
      <div class="up__left">
        <div class="left__box">
          <div class="up__img">
            <img src="../assets/images/footer/footer-women.png" alt="women" />
          </div>
          <p class="up__text">
        ...
        <div class="right__box">
          ...
          <form action="#" class="up__form">
            <input
              ...
              required
            />
            <button class="up__button" type="submit">Subscribe</button>
          </form>
        </div>
      </div>
    </div>
